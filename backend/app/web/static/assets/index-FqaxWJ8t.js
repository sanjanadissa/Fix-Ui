...
async function y(e, t = {}, n, r) {
  let i = { "Content-Type": `application/json`, ...(t.headers || {}) };
  n?.access_token && (i.Authorization = `Bearer ${n.access_token}`);
  let a = await fetch(`${e}`, { ...t, headers: i });
  if (a.status === 401 && n?.refresh_token) {
    let o = await fetch(`/web/auth/refresh`, {
      method: `POST`,
      headers: { "Content-Type": `application/json` },
      body: JSON.stringify({ refresh_token: n.refresh_token }),
    });
    if (o.ok) {
      let s = await o.json();
      (r({ ...n, ...s }),
        (i.Authorization = `Bearer ${s.access_token}`),
        (a = await fetch(`${e}`, { ...t, headers: i })));
    }
  }
  if (!a.ok) {
    let e = await a.json().catch(() => ({}));
    throw Error(e.error || `Request failed (${a.status})`);
  }
  ...
  return (
    ...
    }, [e]),
    {
      ...
      signIn: () => {
        ...
        if (!e) {
          (a(!1), s(`Please allow popups for this site and try again.`));
          return;
        }
        let t = Date.now(),
          n = window.setInterval(() => {
            if (Date.now() - t > x) {
              (window.clearInterval(n),
                e.closed || e.close(),
                a(!1),
                s(`Login timed out. Please try again.`));
              return;
            }
            if (e.closed) {
              (window.clearInterval(n), a(!1));
              return;
            }
            try {
              if (!e.location.href.startsWith(window.location.origin)) return;
              let t = e.document.body?.innerText || ``;
              if (!t) return;
              if (!t.includes(`access_token`)) {
                (window.clearInterval(n), e.close(), a(!1));
                try {
                  s(JSON.parse(t).error || `Login failed. Please try again.`);
                } catch {
      ...
      signOut: async () => {
        try {
          await y(`/web/auth/logout`, { method: `POST` }, e, c);
        } catch {}
        (c(null), r(null));
      },
    }
...
var S = [
    ...
    },
    {
      ...
      excerpt: `Local setup, env vars and the ingestion CLI. Covers parser plugins for PDF, Markdown and Google Docs exports.`,
    ...
    },
    {
      ...
      excerpt: `What broke during the June drill, how long DNS propagation actually took, and the follow-up actions still open.`,
  ...
  te = [`All projects`, `Platform`, `Payments`, `People`, `Design`],
  ne = [
  ...
  w = _.createContext && _.createContext(re),
  ie = [`attr`, `size`, `title`];
function ae(e, t) {
  if (e == null) return {};
  var n,
...
function de(e) {
  return (
    e &&
    e.map((e, t) => _.createElement(e.tag, le({ key: t }, e.attr), de(e.child)))
  );
}
function fe(e) {
  return (t) =>
    _.createElement(pe, se({ attr: le({}, e.attr) }, t), de(e.child));
}
function pe(e) {
  var t = (t) => {
    var n = e.attr,
    ...
    return (
      ...
      _.createElement(
        ...
        se(
          ...
          {
            className: s,
            style: le(le({ color: e.color || t.color }, t.style), e.style),
            height: o,
            width: o,
  ...
  return w === void 0 ? t(re) : _.createElement(w.Consumer, null, (e) => t(e));
}
function me(e) {
  return fe({
    tag: `svg`,
...
function he({ onSignIn: e, busy: t, error: n }) {
  return (0, O.jsxs)(`div`, {
    className: `login-screen`,
    children: [
      (0, O.jsx)(`div`, { className: `login-glow` }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
            ...
            children: [
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, O.jsx)(`strong`, { children: `Atlas` }),
                ],
              }),
              (0, O.jsx)(`h1`, {
                children: `Every answer your team already wrote down.`,
              }),
              (0, O.jsx)(`p`, {
                children: `Atlas indexes uploads, Drive folders, READMEs and saved articles, plus the threads your colleagues have already answered.`,
              }),
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsxs)(`div`, {
                    children: [
                      ...
                      (0, O.jsx)(`b`, { children: `One search box` }),
                      (0, O.jsx)(`small`, {
                        children: `Docs, articles and accepted answers in one place.`,
                      }),
                    ],
                  }),
                  (0, O.jsxs)(`div`, {
                    children: [
                      (0, O.jsx)(`span`, { children: `◇` }),
                      (0, O.jsx)(`b`, { children: `Ask when search fails` }),
                      (0, O.jsx)(`small`, {
                        children: `Route questions to the people who own the area.`,
                      }),
                    ],
                  }),
                  (0, O.jsxs)(`div`, {
                    children: [
                      (0, O.jsx)(`span`, { children: `⧗` }),
                      (0, O.jsx)(`b`, { children: `Trust what you find` }),
                      (0, O.jsx)(`small`, {
                        children: `Version history makes stale knowledge visible.`,
                      }),
                    ],
                  }),
                ],
          ...
          (0, O.jsxs)(`section`, {
            ...
            children: [
              (0, O.jsx)(`h2`, { children: `Sign in` }),
              (0, O.jsx)(`p`, {
                children: `Use your work Google account. Access follows your existing project groups.`,
              }),
              (0, O.jsxs)(`button`, {
                ...
                children: [
                  ...
                  t ? `Waiting for Google...` : `Continue with Google`,
                ],
              }),
              n &&
                (0, O.jsx)(`div`, { className: `error-message`, children: n }),
              (0, O.jsxs)(`div`, {
                className: `secure-note`,
                children: [
                  (0, O.jsx)(`span`, { className: `online` }),
                  `Drive stays read-only until you choose folders to sync.`,
                ],
              }),
              (0, O.jsx)(`small`, {
                className: `policy`,
                children: `Only verified Codimite workspace accounts can access the hub.`,
              }),
            ],
          }),
        ],
  ...
  return (0, O.jsxs)(`header`, {
    ...
    children: [
      ...
      (0, O.jsxs)(`div`, {
        className: `brand`,
        children: [
          (0, O.jsx)(`span`, { className: `brand-mark`, children: `✦` }),
          (0, O.jsx)(`strong`, { children: `Atlas` }),
        ],
      }),
      (0, O.jsxs)(`div`, {
      ...
      (0, O.jsx)(`button`, {
        ...
        onClick: i,
        title: `Sign out`,
        children: (e.name || e.email || `U`).slice(0, 2).toUpperCase(),
      }),
    ],
  });
}
function _e({ icon: e, label: t, count: n, active: r, onClick: i }) {
  return (0, O.jsxs)(`button`, {
    className: `nav-button ${r ? `active` : ``}`,
    onClick: i,
    children: [
      (0, O.jsx)(`span`, { children: e }),
      t,
      (0, O.jsx)(`small`, { children: n }),
    ],
  });
}
function ve({ open: e, view: t, project: n, onView: r, onProject: i }) {
  let a = (e) => () => {
    e();
  };
  return (0, O.jsxs)(`aside`, {
    ...
    children: [
      ...
      (0, O.jsx)(`div`, { className: `side-label`, children: `Projects` }),
      te.map((e) =>
        (0, O.jsxs)(
          `button`,
          {
            className: `project-link ${n === e ? `active` : ``}`,
            onClick: a(() => i(e)),
            children: [
              (0, O.jsx)(`span`, {
      ...
      (0, O.jsx)(`div`, {
        ...
        children: (0, O.jsxs)(`div`, {
          children: [
            ...
            (0, O.jsx)(`p`, { children: `3 folders · last synced 12 min ago` }),
            (0, O.jsx)(`button`, {
              onClick: () => r(`sources`),
...
function ye({ label: e }) {
  return (0, O.jsx)(`span`, {
    className: `status ${e.toLowerCase().replace(` `, `-`)}`,
    children: e,
  });
}
function be({ doc: e, onClick: t }) {
  return (0, O.jsxs)(`button`, {
    className: `document-card`,
    onClick: t,
    children: [
      (0, O.jsx)(`span`, { className: `doc-icon`, children: e.icon }),
      (0, O.jsxs)(`span`, {
        className: `doc-body`,
        children: [
          (0, O.jsxs)(`span`, {
            className: `doc-title`,
            children: [
              (0, O.jsx)(`b`, { children: e.title }),
              (0, O.jsx)(ye, { label: e.status }),
            ],
          }),
          (0, O.jsx)(`span`, { className: `doc-excerpt`, children: e.excerpt }),
          (0, O.jsxs)(`span`, {
            className: `doc-meta`,
            children: [e.type, ` · `, e.project, ` · `, e.meta],
          }),
        ],
      }),
      (0, O.jsx)(`span`, { className: `arrow`, children: `›` }),
    ],
  });
}
function xe({ query: e, onQuery: t, project: n, docs: r, onDocClick: i }) {
    ...
    children: [
      (0, O.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, O.jsx)(`h1`, {
            children: e ? `Results for "${e}"` : `What are you looking for?`,
          }),
          (0, O.jsx)(`p`, {
            children: `Search across docs, READMEs, imported articles and accepted answers.`,
          }),
          (0, O.jsx)(`div`, {
            ...
            children: [
              ...
              (0, O.jsx)(`button`, { onClick: () => t(e), children: e }, e),
            ),
          }),
        ],
      }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, O.jsx)(`span`, {
            ...
            children: `Current · Outdated · In review`,
          }),
        ],
      }),
      (0, O.jsx)(`div`, {
        className: `doc-list`,
        children: r.map((e) =>
          (0, O.jsx)(be, { doc: e, onClick: () => i(e) }, e.id),
        ),
      }),
    ],
  });
}
function Se({ title: e, subtitle: t, action: n, onAction: r }) {
  return (0, O.jsxs)(`div`, {
    className: `page-title`,
    children: [
      (0, O.jsxs)(`div`, {
        children: [
          (0, O.jsx)(`h2`, { children: e }),
...
function Ce({ thread: e, onClick: t }) {
  return (0, O.jsxs)(`button`, {
    ...
    children: [
      (0, O.jsxs)(`span`, {
        ...
        children: [
          (0, O.jsx)(ye, { label: e.status }),
          (0, O.jsx)(`small`, { children: e.project }),
        ],
      }),
      (0, O.jsx)(`b`, { children: e.title }),
      (0, O.jsx)(`p`, { children: e.preview }),
      (0, O.jsx)(`small`, { className: `mono`, children: e.meta }),
    ],
  });
}
function we({ onAsk: e, onThreadClick: t }) {
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(Se, {
        title: `Threads`,
      ...
      (0, O.jsx)(`div`, {
        ...
        children: C.map((e) =>
          (0, O.jsx)(Ce, { thread: e, onClick: () => t(e) }, e.id),
        ),
      }),
    ],
  });
  ...
  return (0, O.jsx)(`div`, {
    ...
    children: (0, O.jsxs)(`section`, {
      ...
      children: [
        ...
        n && (0, O.jsx)(De, { doc: e }),
        r && (0, O.jsx)(Oe, { thread: e }),
        !n && !r && (0, O.jsx)(ke, { type: e, close: t }),
      ],
    }),
  });
}
  ...
  return (0, O.jsxs)(O.Fragment, {
    children: [
      ...
      (0, O.jsxs)(`span`, {
        ...
        children: [e.type, ` · `, e.project],
      }),
      (0, O.jsx)(`h2`, { children: e.title }),
      (0, O.jsx)(`p`, { children: e.excerpt }),
      (0, O.jsxs)(`div`, {
        className: `panel-actions`,
        children: [
          (0, O.jsx)(`button`, { children: `Mark as outdated` }),
          (0, O.jsx)(`button`, { children: `Open source` }),
        ],
      }),
      (0, O.jsx)(`h3`, { children: `Version history` }),
      (0, O.jsxs)(`div`, {
        className: `history`,
        children: [
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(`b`, { children: `v4.2` }),
              (0, O.jsxs)(`span`, {
                children: [
                  `Added the latest operational guidance`,
                  (0, O.jsx)(`small`, { children: `Nadia R. · 12 Aug 2026` }),
                ],
              }),
            ],
          }),
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(`b`, { children: `v4.1` }),
              (0, O.jsxs)(`span`, {
                children: [
                  `Escalation ladder updated`,
                  (0, O.jsx)(`small`, { children: `Tom B. · 27 Jun 2026` }),
                ],
              }),
            ],
          }),
...
function Oe({ thread: e }) {
  return (0, O.jsxs)(O.Fragment, {
    children: [
      ...
      (0, O.jsxs)(`span`, {
        className: `panel-kicker`,
        children: [`Thread · `, e.project],
      }),
      (0, O.jsx)(`h2`, { children: e.title }),
      (0, O.jsx)(`span`, { className: `mono`, children: e.meta }),
      (0, O.jsxs)(`p`, {
        children: [
          e.preview,
          ` The team is collecting the confirmed answer here so it can be found again later.`,
        ],
      }),
      (0, O.jsxs)(`div`, {
        className: `answer`,
        children: [
          (0, O.jsx)(`b`, { children: `✓ Accepted answer` }),
          (0, O.jsx)(`p`, {
            children: `Replay the pending work using the current runbook. Anything older than the supported window needs a manual review in the provider console.`,
          }),
        ],
      }),
      (0, O.jsxs)(`div`, {
        className: `reply`,
        children: [
          (0, O.jsx)(`input`, { placeholder: `Write an answer...` }),
          (0, O.jsx)(`button`, { children: `Post` }),
        ],
      }),
    ],
  });
}
function ke({ type: e, close: t }) {
  let n = e === `ask`;
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(`h2`, { children: n ? `Ask the team` : `Add to the hub` }),
      (0, O.jsx)(`p`, {
        children: `Share a question or source with the team and keep the knowledge searchable.`,
      }),
      (0, O.jsx)(`input`, {
      ...
      (0, O.jsx)(`textarea`, { placeholder: `Add context...`, rows: `5` }),
      (0, O.jsx)(`button`, {
        className: `primary-action`,
        onClick: t,
        children: n ? `Post question` : `Add to hub`,
      }),
    ],
  });
}
function Ae() {
  let { user: e, session: t, busy: n, error: r, signIn: i, signOut: a } = ee(),
    [o, s] = (0, _.useState)(`search`),
    [c, l] = (0, _.useState)(``),
    [u, d] = (0, _.useState)(`All projects`),
    [f, p] = (0, _.useState)(!1),
    [m, h] = (0, _.useState)(null),
    g = (0, _.useMemo)(
      () =>
        S.filter((e) => {
          let t = `${e.title} ${e.excerpt} ${e.tags.join(` `)}`.toLowerCase();
          return (
            (u === `All projects` || e.project === u) &&
  ...
  return !t || !e
    ? (0, O.jsx)(he, { busy: n, error: r, onSignIn: i })
    : (0, O.jsxs)(`div`, {
        className: `app-shell`,
        children: [
          (0, O.jsx)(ge, {
            ...
            children: [
              ...
              (0, O.jsxs)(`main`, {
                ...
                children: [
                  ...
                  o === `threads` &&
                    (0, O.jsx)(we, { onAsk: () => h(`ask`), onThreadClick: h }),
                  o === `sources` && (0, O.jsx)(Te, {}),
                ],
              }),
            ],
          }),
          m && (0, O.jsx)(Ee, { data: m, close: () => h(null) }),
          (0, O.jsxs)(`div`, {
            className: `user-status`,
            children: [`Signed in as `, e.email],
          }),
        ],
      });
}
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, O.jsx)(_.StrictMode, { children: (0, O.jsx)(Ae, {}) }),
);
